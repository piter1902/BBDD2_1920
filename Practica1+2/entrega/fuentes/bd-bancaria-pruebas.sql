...
-- ************************************** "Operacion"
INSERT INTO TRANSACCION VALUES (1, 1235567891, 1234567892, TO_DATE('2020-03-14', 'YYYY-MM-DD'), 10, 'Transferencia 1', 418);
INSERT INTO TRANSACCION VALUES (1, 1234567892, 1234567991, TO_DATE('2020-03-15', 'YYYY-MM-DD'), 10, 'Transferencia 2', 5801);
INSERT INTO TRANSACCION VALUES (2, 1234567892, 3456789011, TO_DATE('2020-03-16', 'YYYY-MM-DD'), 10, 'Transferencia 3', 6912);

INSERT INTO OPERACION VALUES (1, 1235567891, TO_DATE('2020-03-16', 'YYYY-MM-DD'), 10, 'Ingreso 1', 'ingreso', 6912);
INSERT INTO OPERACION VALUES (1, 1234567892, TO_DATE('2020-03-17', 'YYYY-MM-DD'), 10, 'Ingreso 2', 'ingreso', 418);
INSERT INTO OPERACION VALUES (1, 3456789011, TO_DATE('2020-03-18', 'YYYY-MM-DD'), 10, 'Ingreso 3', 'ingreso', 5801);
